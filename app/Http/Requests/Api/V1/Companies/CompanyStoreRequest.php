...
class CompanyStoreRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'fixed_asset_files' => ['nullable', 'required_if:fixed_asset_files_exists,true', 'array'],
            'fixed_asset_files.*' => ['nullable', 'required_if:fixed_asset_files_exists,true', 'file', 'mimes:png,jpg,jpeg,pdf,xlsx,xls,docx,doc'],
