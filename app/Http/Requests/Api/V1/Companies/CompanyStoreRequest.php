...
class CompanyStoreRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'fixed_asset_files' => ['required_if:fixed_asset_files_exists,1', 'array'],
            'fixed_asset_files.*' => ['required_if:fixed_asset_files_exists,1', 'file', 'mimes:png,jpg,jpeg,pdf,xlsx,xls,docx,doc'],
