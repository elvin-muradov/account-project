...
@if($attendanceLogs->count() > 0)
    ...
    <table style="border-collapse: collapse;border:4px solid black">
        ...
        <tr>
            ...
            <th @php echo $cellHeadClass200Width; @endphp>Faktiki <br/>iş saatları</th>
            <th @php echo $cellHeadClass200Width; @endphp>Hesablanmış <br/>əmək haqqı</th>
            ...
            <th @php echo $cellHeadClass200Width; @endphp>Cəmi <br/>Tutulmuşdur</th>
            <th @php echo $cellHeadClass200Width; @endphp>Ödəniləsi <br/>Məbləğ</th>
        </tr>
        </thead>
        <tbody>
        @php
